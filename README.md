...
- Hello World  
  A basic Python script written to understand the structure of a Python
  program and how output works.
...
- Quiz App (CLI)  
  ...
  The program asks multiple-choice questions and calculates the final
  score based on the user’s answers. If the user selects a wrong option,
...
- Practice writing clean, readable, and structured code
